...
* Inputs & Efficiency: Nitrogen_kg_ha, Phosphorus_kg_ha, Potassium_kg_ha, Irrigation_Method, Fertilizer_kg_ha, Pesticide_Litre_ha, Water_Used_m3.
* Economic Outcomes: Yield_Tonnes_Ha, Production_Tonnes, Market_Price_INR_Tonne, Total_Cost_INR, Revenue_INR, Profit_INR.

🔑 Key Findings
* Seasonal Dominance: The Kharif season is the primary driver of total yield and profitability, benefiting from favorable rainfall and ambient temperatures.
* Stable Returns: The Rabi season yields consistent, moderate profitability for staple crops like Wheat and Pulses.
* Zaid Financial Challenges: High heat stress and low water availability lead to significant operational losses during the Zaid season, even for staple crops.
* Optimization Strategy: Highlighting the need for climate-resilient crop selection, drip irrigation adoption, and strategic fallowing during vulnerable months. 
